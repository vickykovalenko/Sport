...
namespace Sport.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(DBSportGymContext context)
        {
            _context = context;
        }
        ...
        {
            var dBSportGymContext = _context.Clients.Include(c => c.Trainer);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Phone,Email,TrainerId")] Client client)
        {
